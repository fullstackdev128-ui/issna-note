...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="bg-[#1e3a8a] px-8 py-6 text-white">
            <h3 class="text-2xl font-black uppercase tracking-tighter">Nouvelle Filière</h3>
            <p class="text-blue-200 text-sm mt-1">Créez un nouveau département académique.</p>
        </div>

        <form action="{{ route('referentiel.filieres.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
